            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">contact@eventmaster.com</p>
                  <p className="text-gray-400">support@eventmaster.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">123 Avenue des Événements</p>
